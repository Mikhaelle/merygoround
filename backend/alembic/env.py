...
from merygoround.infrastructure.database.models.wheel import SpinSessionModel  # noqa: F401
...
database_url = os.environ.get(
    "DATABASE_URL",
    "postgresql+asyncpg://postgres:postgres@localhost:5432/merygoround",
)
